...
builder.Services.AddSwaggerGen(c =>
  {
    ...
    {
        Version = "v1",
        Title = "KvaKvaCloud UserDataService API",
    ...
    {
        Description = "Аутентификация при помощи токена типа Access или Microservice.",
        Name = "Authorization",
...
if (app.Environment.IsDevelopment())
{
    app.UseSwagger(c =>
    {
        c.RouteTemplate = "/UserData/swagger/{documentName}/swagger.json";
    });
    app.UseSwaggerUI(c =>
    {
        c.RoutePrefix = "UserData";
        c.SwaggerEndpoint("/UserData/swagger/v1/swagger.json", "v1");
    });
}
